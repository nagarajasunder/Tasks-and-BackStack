...
import com.geekydroid.tasksandbackstack.databinding.ActivityBsingleInstanceBinding

private const val TAG = "ActivityBSingleInstance"
class ActivityBSingleInstance : AppCompatActivity() {

    private lateinit var binding:ActivityBsingleInstanceBinding
    private lateinit var launchModeStr:String

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_bsingle_instance)
